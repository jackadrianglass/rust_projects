// An implementation of an ok stack
...
mod tests {
    ...
    fn peek() {
        ...
        let _ = list.peek_mut().map(|val| *val = 2);
    ...
    fn iter() {
        ...
        // check that we can still look into the original thing
    ...
    fn iter_mut() {
        ...
        let _ = iter.next().take().map(|val| *val = 4);
