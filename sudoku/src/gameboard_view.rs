...
pub struct GameboardViewSettings {
    ...
    pub position: [f64; 2],
    /// Size of gameboard along horizontal and verical edge
    pub size: f64,
    /// Background color
...
impl GameboardViewSettings {
    ...
    pub fn new() -> GameboardViewSettings {
        GameboardViewSettings {
            position: [10.0; 2],
            size: 400.0,
            background_color: [0.7, 1.0, 1.0, 1.0],
            ...
            selected_cell_background_color: [0.9, 1.0, 1.0, 1.0],
...
impl GameboardView {
        ...
        C: CharacterCache<Texture = G::Texture>,
    {
        ...
        // Generate and draw the line for the Sudoku Grid
        for i in 0..9 {
